...
public class Level22 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>In this level"
            +"<br>you have two optional attacks to choose from. "
            +"<br>Choose one of them to attack!"
            +"<br>*** On this level, the enemy is easy for you to defeat"
            +"<br>but you still risk losing! Be careful!"};
    ...
    public Level22() {
        ...
        // 设置窗口背景
        ImageIcon backgroundImg = new ImageIcon("HP_IMG/Chambre des secrets.jpg");
        ...
        // 创建四个选择按钮
        Button1 = new JButton("1. call upon the legendary sword of Godric Gryffindor");
        ...
        Button2 = new JButton("2. Attack Basilic's teeth");
        ...
        ComponentListener componentListener = new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                imageLabel.setBounds(20, 400, 300, 800);

                Button1.setBounds(200, 350, 1000, 100);
                Button2.setBounds(300, 550, 600, 100);
