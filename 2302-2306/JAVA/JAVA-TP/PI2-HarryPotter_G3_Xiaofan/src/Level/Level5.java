...
public class Level5 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>You have arrived 【Salle d’examen de Poudlard】!"
            +"<br>Here you will use and be subject to attacks of AP."
            +"<br>You need to get and use fireworks to get Dolores Ombrage's attention"
            +"<br>Watch out for dodging your opponent's attacks!"
            +"<br>Are you ready to fight?!Click to <CONTINUE>!"
            +"<br>"
            +"<br>!!! Dolores Ombrage is coming !!!"
    };
