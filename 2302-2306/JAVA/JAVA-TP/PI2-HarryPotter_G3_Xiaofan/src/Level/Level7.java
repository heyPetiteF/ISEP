...
public class Level7 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>You have arrived 【Poudlard】!"
            +"<br>Here you will use and be subject to attacks of AP."
            +"<br>You need to use all your power to defeat your enemies"
            +"<br>Watch out for dodging your opponent's attacks!"
            +"<br>Are you ready to fight?!Click to <CONTINUE>!"
            +"<br>"
            +"<br>!!! Voldemort and Bellatrix Lestrange are coming !!!"
    };
