...
public class preLevel extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>Congratulations on completing your initial selection"
                            +"<br>here is some data"
                            +"<br>that may help you in your subsequent judgement"
                            +"<br>"
                            +"<br>Health Points: " + Base.getHP()
                            +"<br>Attack Accuracy: " + Base.getSA()
                            +"<br>Number of potions: "+ Base.getNumPotions()
                            +"<br>"
                            +"<br>Ready to fight your enemies?"
                            +"<br>! LET'S GO !"};
