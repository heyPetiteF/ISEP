...
public class Level33 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>In this level"
            +"<br> you can learn a skill and attack the enemy with it."
            +"<br>Start learning & attacking! "
    ...
    public Level33() {
        ...
        // 设置窗口背景
        ImageIcon backgroundImg = new ImageIcon("HP_IMG/Lake.jpg");
        ...
        // 创建四个选择按钮
        Button1 = new JButton("Click to learn a new spell and use it!");
        ...
        ComponentListener componentListener = new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                imageLabel.setBounds(10, 400, 300, 800);

                Button1.setBounds(150, 500, 1000, 100);
