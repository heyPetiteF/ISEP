...
public class Level55 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>In this room you have a choice of four items."
            ...
            +"<br>and throw it to your enemies!"
            +"<br>*** On this level, the enemies are stronger"
            +"<br>don't take it lightly!"};
    ...
    public Level55() {
        ...
        // 设置窗口背景
        ImageIcon backgroundImg = new ImageIcon("HP_IMG/Salle d’examen de Poudlard.png");
        ...
        ImageIcon imageIcon = new ImageIcon("HP_IMG\\NPC1.png");
        ...
        Button4 = new JButton("4. Notebook");
