...
public class Level4 extends JFrame implements ActionListener {
    ...
    private String[] lines = {"<br>You have arrived 【Cimetière de Little Hangleton】!"
            +"<br>Here you will use and be subject to attacks of AP."
            +"<br>To survive, you must stay close to Portkey."
            +"<br>Watch out for dodging your opponent's attacks!"
            +"<br>Are you ready to fight?!Click to <CONTINUE>!"
            +"<br>"
            +"<br>!!! Voldemort and Peter Pettigrew are coming !!!"
    };
    ...
    public Level4() {
        ...
        // 设置窗口背景
        ImageIcon backgroundImg = new ImageIcon("HP_IMG/Cimetière de Little Hangleton.jpg");
